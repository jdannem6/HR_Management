    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/HR/Manager/create.php">Add Department</a></li>
            <li><a href="/HR/Manager">View Departments</a></li>
          </ul>
          ...
          <ul class="treeview-menu">
            <li><a href="/HR/Manager/create.php">Add Team</a></li>
            <li><a href="/HR/Manager">View Teams</a></li>
          </ul>
        </li>
      </ul>
